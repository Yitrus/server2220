...
TRACE_EVENT(migrate_page_each_anon,
	...
	TP_printk("anon page=0x%lx", (unsigned long)__entry->address)
);

TRACE_EVENT(migrate_page_each_file,
	...
	TP_printk("file page=0x%lx", (unsigned long)__entry->address)
);
