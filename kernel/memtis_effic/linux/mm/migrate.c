...
static bool get_folio_user_vaddr_one(struct page *page, struct vm_area_struct *vma,
					unsigned long addr, void *arg)
{
	trace_mm_migrate_page_user_vaddr_each(addr);

	return true;
}

static void get_folio_user_vaddr_by_rmmap(struct page *page)
{
	struct rmap_walk_control rwc = {
		.rmap_one = get_folio_user_vaddr_one,
	};
...
retry:
			 ...
			 * during migration.
			 */
			get_folio_user_vaddr_by_rmmap(page);
